...
public class GregItems{
    ...
    copper, lead, titanium, stone, Ice, Resin, Iron, rawIron, Silisteel, PES, Circuit, Pizza, Resistor, Transistor, Sulfur, Tube, Vacc, MS ,Buldr, CLG, Diode, Healr, NAND, Mvcircuit,
    PVCS;
